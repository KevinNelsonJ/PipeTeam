...
//this is a weird vector it keeps track of our vector quantity over time and space
  ...
  create_triangulation_and_dofs (const unsigned int n_refines)
  {
    ...
    {
      std::string filename = "input/test_cube_two_materials.ucd";   	//change this line to our grid file name
  ...
  try
    {
      ...
      NavierStokesProjection<3> test (data);		//our problem is 3D, called test
